...
import { sendFile, moveDirectory, setupInputFromSharedDirectory } from '~/utils/powershell-remote/commands/iindex.js';
...
export default class JobLauncher extends EventEmitter {
  constructor() {
    ...
    this.queue.error((err, params) => {
      this.emit(events.ERROR, params.job.toObject(), err);
    });
  }
